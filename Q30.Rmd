...
# dtVBRP <- fread(file.path(".", "RAW_DATA", "VBRP_GOLALL.txt"), 
#                 sep=";", nrows = pROWS)
# setkey(dtVBRP, "VBELN")
# 
...
#             row.names = FALSE, col.names = TRUE, append = FALSE)
# 
# write.table(dtVBRP[substr(dtVBRP$FBUDA, 1, 6) %in% l_months[13:17]], 
#             file = file.path("c:", "FTP", 
#                              paste0("VBRP, "_", 
...
fWriteToSheet(head(dtDATA[1:10])        , pFILE, "dtDATA"   , pAppend = TRUE)
```
