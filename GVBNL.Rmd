...
dtTMP04 <- dtDATA[LMTNR == " "] # MATNR == "A9990002" |
if(nrow(dtTMP04) > 0){
  fWriteToSheet(dtTMP04, pFILE, "Records_DEL", pAppend = TRUE)
  dtDATA <- dtDATA[LMTNR != " "] # MATNR != "A9990002" & 
  }
...
fWriteToSheet(head(dtDATA[1:10])        , pFILE, "tDATA"   , pAppend = TRUE)
```
...
fWriteToSheet(dtTMP01, pFILE, "WERKS_NO_SORT2", pAppend = TRUE )
